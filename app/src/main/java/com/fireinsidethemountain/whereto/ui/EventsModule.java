...
public class EventsModule extends Fragment implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    private EventsModule _eventsModuleFragment = this;
        ...
        if (position != 4) {
            _currentListener = foodEnquiresReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    _adapter.setClickListener(_eventsModuleItemClickListener);
                }
    ...
    private class EventsModuleItemClickListener implements RecyclerViewAdapter.ItemClickListener {
        @Override
        public void onItemClick(View v,int pos) {
            _enquireViewFragment.setEnquire(_enquiresIDs.get(pos), _dataset.get(pos));
            _enquireViewFragment.setPreviousFragment(_eventsModuleFragment);
            _mainScreen.setCurrentFragment(_enquireViewFragment);
        }
    }

    private class EventsModuleAllEnquiresEventListener implements ValueEventListener {
    ...
    private EventsModuleItemClickListener _eventsModuleItemClickListener = new EventsModuleItemClickListener();
    private EventsModuleAllEnquiresEventListener _eventsModuleAllEnquiresEventListener = new EventsModuleAllEnquiresEventListener();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        _currentListener = _enquiresReference.addValueEventListener(_eventsModuleAllEnquiresEventListener);
    ...
    public void onClick(View view) {
        if (view == _topButton) {
            ...
            enquireCreator.getSpinner().setSelection(2);
