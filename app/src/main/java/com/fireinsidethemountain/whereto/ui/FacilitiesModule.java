...
public class FacilitiesModule extends Fragment implements View.OnClickListener, AdapterView.OnItemSelectedListener{
    ...
    private FacilitiesModule _facilitiesModuleFragment = this;
            ...
            _currentListener = foodEnquiresReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (e.getType() == Enquire.EnquireType.Facilities) {
                    ...
                    _adapter.setClickListener(_facilitiesModuleItemClickListener);
                }
    ...
    private class FacilitiesModuleItemClickListener implements RecyclerViewAdapter.ItemClickListener {
        @Override
        public void onItemClick(View v,int pos) {
            _enquireViewFragment.setEnquire(_enquiresIDs.get(pos), _dataset.get(pos));
            _enquireViewFragment.setPreviousFragment(_facilitiesModuleFragment);
            _mainScreen.setCurrentFragment(_enquireViewFragment);
        }
    }

    private class FacilitiesModuleAllEnquiresEventListener implements ValueEventListener {
    ...
    private FacilitiesModuleItemClickListener _facilitiesModuleItemClickListener = new FacilitiesModuleItemClickListener();
    private FacilitiesModuleAllEnquiresEventListener _facilitiesModuleAllEnquiresEventListener = new FacilitiesModuleAllEnquiresEventListener();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        _currentListener = _enquiresReference.addValueEventListener(_facilitiesModuleAllEnquiresEventListener);
    ...
    public void onClick(View view) {
        if (view == _topButton) {
            ...
            enquireCreator.getSpinner().setSelection(3);
